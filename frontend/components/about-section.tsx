...
/* ── stat block ── */
const STATS = [
    { label: "POLICY_MODE", value: "HYBRID" },
    { label: "DECISION_STATES", value: "03" },
    { label: "RISK_THRESHOLD", value: "70" },
    { label: "0G_CHAIN", value: "16602" },
]
...
export function AboutSection() {
  return (
    <section id="architecture" className="w-full px-6 py-20 lg:px-12">
      {/* Section label */}
      <motion.div
      ...
      >
        <span className="text-[10px] tracking-[0.2em] uppercase text-muted-foreground font-mono">
          {"// SECTION: 0G_SECURITY_ARCHITECTURE"}
        </span>
          ...
          <div className="flex-1 flex flex-col justify-between px-5 py-6 lg:py-8">
            <div className="flex flex-col gap-6">
              ...
              >
                A safer runtime for
                <br />
                <span className="text-[#ea580c]">autonomous agents</span>
              </motion.h2>
              ...
              >
                ...
                <span className="font-mono text-[#ea580c]">DEPLOYED / GALILEO</span>
              </motion.div>
            </div>
