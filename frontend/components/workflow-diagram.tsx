...
const LEFT_LABELS = ["INTENT", "RISK", "POLICY"]
const RIGHT_LABELS = ["WALLET", "PROOF", "AUDIT"]
  ...
  return (
    <div className="relative w-full max-w-[800px] mx-auto">
      <svg
        ...
        role="img"
        aria-label="Workflow diagram showing connected security stages: Intent, Risk, Policy, Wallet, Proof, Audit"
      >
