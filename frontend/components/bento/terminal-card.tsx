...
const LOG_LINES = [
  ...
  "> Parsing intent payload...",
  "> Resolving destination",
  "> Checking protocol allowlist",
  "> Comparing spend limits",
  "> Scanning for injection patterns",
  "> Simulating wallet call",
  "> Example risk score: 08 / 100",
  "> Example policy: ALLOWED",
  "> Writing local decision record...",
  "> Demo trace: COMPLETE",
  "> --------- CHECK COMPLETE ---------",
]
