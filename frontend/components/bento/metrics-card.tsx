  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col justify-center gap-6 p-6">
        <ScrambleNumber target="70/100" label="Block threshold" delay={500} />
        <ScrambleNumber target="16602" label="0G chain id" delay={800} />
        <ScrambleNumber target="03" label="Decision states" delay={1100} />
        <ScrambleNumber target="02" label="Budget constraints" delay={1400} />
      </div>
    </div>
  )
}
