...
const TIERS: Tier[] = [
  {
    ...
    features: [
      ...
      { text: "Spending policy engine", included: true },
      { text: "0G testnet wallet flow", included: true },
      { text: "Remote report storage", included: false },
      { text: "Team approvals", included: false },
    ],
    cta: "OPEN CONSOLE",
    highlighted: false,
  },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "Operator-selected model", included: true },
      { text: "Model inference adapter", included: false },
      { text: "0G Storage report adapter", included: false },
      { text: "Team approval service", included: false },
    ],
    cta: "OPEN CONSOLE",
    highlighted: false,
  },
  ...
  return (
    ...
    >
      ...
      <div className="px-5 pt-6 pb-4">
        <div className="flex items-baseline gap-1">
          <span className="text-3xl lg:text-4xl">
            <ScrambleValue target={tier.price} />
          </span>
          {tier.period && (
            <span
      ...
      <div className="px-5 pb-5 pt-3">
        ...
        >
          <Link href="/console" className={`group w-full flex items-center justify-center gap-0 text-xs font-mono tracking-wider uppercase ${tier.highlighted ? "bg-background text-foreground" : "bg-foreground text-background"}`}>
